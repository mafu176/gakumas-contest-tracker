              ...
              <div className="mt-3 grid grid-cols-1 gap-2 md:grid-cols-2">
                {item.changes.slice(0, 6).map((change) => (
                  <div
                    ...
                    className="rounded-xl bg-black/20 p-3 text-xs text-zinc-300"
                  >
                    ...
                    <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2">
                      <div className="min-w-0">
                        <div className="text-[10px] text-zinc-500">変更前</div>
                      ...
                      <div className="min-w-0">
                        <div className="text-[10px] text-zinc-500">変更後</div>
                ...
                {item.changes.length > 6 && (
                  <div className="rounded-xl bg-black/20 p-3 text-xs text-zinc-500">
