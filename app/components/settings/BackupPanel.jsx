...
export default function BackupPanel({
  ...
  return (
    <section className={`${visible ? "" : "hidden"} rounded-3xl bg-white p-6 shadow`}>
      ...
      >
        <h2 className="text-xl font-semibold text-zinc-900">バックアップ / 復元</h2>
