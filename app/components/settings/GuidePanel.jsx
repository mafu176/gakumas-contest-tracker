      ...
      {showGuide && (
        <div className="mt-4 space-y-6 text-sm leading-7 text-zinc-700">
          <section>
            ...
            <p className="mt-2">
              また、戦績データ共有を有効にすると、サービス改善および利用状況分析のためのデータ提供にもご協力いただけます。
            </p>
          </section>
          ...
          <section>
            ...
            <h4 className="mt-3 font-semibold text-zinc-900">戦績データ共有</h4>
            <p>有効化すると、サービス改善および利用状況分析のため、戦績情報や編成情報を送信します。</p>
            <p>送信データには、プレイヤー名、戦績情報、編成情報などが含まれる場合があります。</p>
            <p>送信は設定画面からいつでも無効化できます。</p>
            <p>プレイヤー名は任意入力です。</p>
            <p>未入力でも利用できます。</p>
          </section>
