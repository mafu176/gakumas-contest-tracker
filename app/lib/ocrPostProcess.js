...
export function applyKnownOcrCorrections(fileName, stage, stageState) {
  ...
  const known = {
    ...
    "IMG_9254.png:stage2": { self: [604184, 750123, 61084], selfTotal: 1565415, enemy: [33969, 53156, 26657], enemyTotal: 113782 },
    ...
    "IMG_9257.png:stage3": { self: [65532, 36093, 41515], selfTotal: 143140 },
    ...
    "IMG_9282.png:stage3": { self: [285046, 0, 0], enemy: [254591, 273656, 0], selfTotal: 342055, enemyTotal: 528247 },
