  ...
  return (
    <main className="min-h-screen bg-zinc-100 p-4 md:p-6">
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className={`${showTab("input", "formation") ? "" : "hidden"} grid grid-cols-1 gap-6 lg:grid-cols-3`}>
          <div className={`space-y-6 rounded-3xl bg-white p-6 shadow ${activeTab === "formation" ? "lg:col-span-3" : "lg:col-span-2"}`}>
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
